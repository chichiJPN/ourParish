...
<head>
   ...
   <script src="<?php echo base_url(); ?>html_attrib\parishStyles\js\ajax.googleapis.jquery.min.js" type="text/javascript" ></script>
  <script src="<?php echo base_url(); ?>html_attrib/jquery-1.11.1.min.js"></script>
