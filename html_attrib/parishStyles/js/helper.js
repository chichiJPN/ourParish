...
function MonthSwitcher()
{
	...
	this.months["January 2014"] = "index/parish_site/months/january";
	this.months["February 2014"] = "index/parish_site/months/febuary";
	this.months["March 2014"] = "index/parish_site/months/march";
	this.months["April 2014"] = "index/parish_site/months/april";
	this.months["May 2014"] = "index/parish_site/months/may";
	this.months["June 2014"] = "index/parish_site/months/june";
	this.months["July 2014"] = "index/parish_site/months/july";
	this.months["August 2014"] = "index/parish_site/months/august";
	this.months["September 2014"] = "index/parish_site/months/september";
	this.months["October 2014"] = "index/parish_site/months/october";
	this.months["November 2014"] = "index/parish_site/months/november";
	this.months["December 2014"] = "index/parish_site/months/december";
...
function ServiceSwitcher()
{
	this.urls = {};
	var base_url = $("#init").data('base_url');
	this.urls["Reading of the Day"] = base_url +"index.php/parish_site/sched/read";
	this.urls["Mass Schedule"] =base_url + "index.php/parish_site/sched/mass";
	this.urls["Baptism"] = base_url +"index.php/parish_site/sched/bapt";
	this.urls["Confession"] = base_url +"index.php/parish_site/sched/confess";
	this.urls["Confirmation"] = base_url +"index.php/parish_site/sched/confirm";
